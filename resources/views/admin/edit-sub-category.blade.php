                ...
                <form class="form-horizontal" action="{{route('admin.save.sub_category')}}" method="POST" enctype="multipart/form-data" role="form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" accept="image/png,image/jpeg" id="picture1" name="picture1" placeholder="{{tr('picture1')}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" accept="image/png,image/jpeg" id="picture2" name="picture2" placeholder="{{tr('picture2')}}">
                                 <p class="help-block">Please enter .png .jpeg .jpg images only.</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" accept="image/png,image/jpeg" id="picture3" name="picture3" placeholder="{{tr('picture3')}}">
                                 <p class="help-block">Please enter .png .jpeg .jpg images only.</p>
                            </div>
                        </div>
