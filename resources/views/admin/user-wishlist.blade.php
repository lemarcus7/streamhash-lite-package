            							...
            							<ul class="admin-action btn btn-default">
            								...
            								@endif	
								                ...
								                <ul class="dropdown-menu">
								                  	<li role="presentation"><a role="menuitem" tabindex="-1" onclick="return confirm('Are you sure?');" href="{{route('admin.delete.wishlist' , $wishlist->wishlist_id)}}">{{tr('delete')}}</a></li>
								                </ul>
